...
Here I only want to show the pet type question if the user owns more than 1 pet. If you input a number greater than 1 in the pet number question, the pet type question will appear.
